...
enum OpInfo {
    ...
    CMPSUOLE = 'Returns signed 1 if its two operands are equal or the first is is less than the second otherwise 0. (Unordered, ignores null values)\n{ cmpsuole <ty> <op1> <op2> }',
    CMPSUOLT = 'Returns signed 1 if the first operand is is less than the second otherwise 0. (Unordered, ignores null values)\n{ cmpsuolt <ty> <op1> <op2> }',
